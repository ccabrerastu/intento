...
mywindow.iconbitmap('C:\\Users\\Usuario\\Desktop\\PROYECTO PROGRAMA DE REGISTRO MÉDICO\\corazon.ico')

# Se crean los botones para cada opción
registrar_boton=Button(mywindow,text="Registrar paciente", font=("Fira sans", 10), width="30", height="2", command=registrar, bg="#FEE75C")
# El .place sirve para ubicar en el lugar que queramos el botón usando coordenadas
registrar_boton.place(x=215, y=125)

image=Image.open("salud.png")
image=image.resize((125,125), Image.LANCZOS)

img=ImageTk.PhotoImage(image)
lbl_img=Label(mywindow,image=img).place(x=45, y=200)
